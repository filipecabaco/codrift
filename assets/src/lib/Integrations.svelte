<script lang="ts">
  ...
  // Esc abandons an in-flight authorization rather than the whole Settings
  // window — the browser tab is still open and the user meant to give up on it.
...
<div class="flex h-full min-h-0 flex-col">
  ...
  <p class="shrink-0 border-t border-border px-4 py-2 text-[11px] text-muted">
    Tokens are stored locally in <code class="rounded bg-canvas px-1">~/.codrift</code>.
  </p>
</div>
